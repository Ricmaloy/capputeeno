...
describe('Cart Page', () => {
  it('renders correctly when cart is empty', () => {
    ...
    expect(
      screen.getByText(/SEU CARRINHO PARECE ESTAR VAZIO! 😔/i),
    ).toBeInTheDocument();
      ...
      cart: [
        {
          ...
          description:
            'Nulla omnis aut doloribus. Perferendis cum est quo nostrum aliquam commodi est in repudiandae. Aut maiores est quod non eum sunt consequatur. Et porro minima iste sint. Excepturi at eos eligendi aut repellendus sed quis voluptatem. Aut et ut qui amet quae.',
          price: 6681,
          imageUrl:
        ...
        },
        {
          ...
          description:
            'Placeat a voluptatem. Consequuntur exercitationem delectus. Ex numquam illum autem aliquam tempora labore. Facilis dicta distinctio ut. Et occaecati nostrum ab eos veritatis eius iure consectetur. Praesentium excepturi qui perferendis tempore.',
          price: 8851,
          imageUrl:
        ...
        },
        {
          ...
          description:
            'Est nostrum accusamus illum rem. Quisquam rem blanditiis sunt error. Est quod numquam et sapiente odit aspernatur.',
          price: 9106,
          imageUrl:
  ...
  it('renders correctly when cart total price is higher than R$ 900000', () => {
    ...
    expect(
      screen.getByRole('heading', {
        name: 'Cart total price with free freight',
      }),
    ).toBeInTheDocument();
  });
});
